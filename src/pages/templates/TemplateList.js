    ...
    <div className="container">
            <div className="row">
                ...
                <div className="card-body">
                    ...
                    <Link className="btn btn-outline-primary btn-sm mt-3" to={"/contacts"}>View all Certificates</Link>
                </div>
                </div>
                </div>
                <div className="col-lg-3">
                ...
                <div className="card-body">
                    ...
                    <h2 className="display-4">45</h2>
                    <Link className="btn btn-outline-primary btn-sm mt-3" to={"/templates"}>View all Energy Bills</Link>
                </div>
                </div>
                </div>
            </div>
